<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="panel.aspx.cs" Inherits="ProjeXXX.panel" %>
...
<body>
 ...
 <!-- Overlay Div -->
			...
			<ul class="nav-notification clearfix">
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						...
						<span class="notification-label bounceIn">7</span>
					</a>
					<ul class="dropdown-menu message dropdown-1">
						<li><a>You have 4 new unread messages</a></li>					  
						<li>
							<a class="clearfix" href="#">
								<img src="http://via.placeholder.com/300x300" alt="User Avatar">
								<div class="detail">
						...
						<li>
							<a class="clearfix" href="#">
								...
								<div class="detail">
									...
									<small class="text-muted"><i class="fa fa-reply"></i> 9 Feb 2017</small>
								</div>
							</a>	
						</li>
				...
				<li class="dropdown hidden-xs">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<span class="notification-label bounceIn">4</span>
					</a>
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						...
						<span class="notification-label bounceIn">5</span>
					</a>
					...
					<ul class="dropdown-menu">
						<li>
							<a class="clearfix" href="#">
								...
								<div class="detail">
									<strong>Ravi Jaiswal</strong>
									<p class="grey">Ravi_Jaiswal@email.com</p> 
								</div>
							</a>
						</li>
		...
		<aside class="default">
			<div class="sidebar-inner scrollable-sidebar">
				...
				<div class="user-block clearfix">
					<img src="http://via.placeholder.com/300x300" alt="User Avatar">
					<div class="detail">
						<strong>Ravi Jaiswal</strong><span class="badge badge-danger m-left-xs bounceIn">4</span>
				...
				<div class="main-menu">
					<ul>
						...
						<li class="openable">
							<a href="#">
								...
								<span class="badge badge-success bounceIn">9</span>
								<span class="menu-hover"></span>
							</a>
							<ul class="submenu">
						...
						<li>
							<a href="inbox.html">
								...
								<span class="badge badge-danger bounceIn">4</span>
								<span class="menu-hover"></span>
							</a>
						</li>
						<li>
							<a href="email_selection.html">
								...
								<small class="badge badge-warning bounceIn">New</small>
								<span class="menu-hover"></span>
							</a>
						</li>
						<li class="openable">
							...
							<ul class="submenu">
								<li class="openable">
									<a href="#">
										...
										<span class="badge badge-danger bounceIn pull-right">3</span>
									</a>
									<ul class="submenu third-level">
										...
										<li class="openable">
											<a href="#">
												...
												<span class="badge badge-danger bounceIn pull-right">2</span>
											</a>
								...
								<li class="openable">
									<a href="#">
										...
										<span class="badge badge-success bounceIn pull-right">3</span>
									</a>
									<ul class="submenu third-level">
										<li class="openable">
											<a href="#">
												<span class="submenu-label">menu 3.1</span>
												<span class="badge badge-success bounceIn pull-right">2</span>
											</a>
											<ul class="submenu fourth-level">
												<li><a href="#"><span class="submenu-label">menu 4.1</span></a></li>
												<li><a href="#"><span class="submenu-label">menu 4.2</span></a></li>
					...
					<div class="alert alert-info">
						Welcome to Sarah Admin. Do not forget to check all my pages. 
					</div>
				</div><!-- /main-menu -->
			</div><!-- /sidebar-inner -->
		</aside>
		...
		<div id="main-container">
			...
			<div class="main-header clearfix">
				<div class="page-title">
					...
					<span>Welcome back Mr.Ravi Jaiswal</span>
				</div><!-- /page-title -->
			...
			<div class="padding-md">
				...
				<div class="row">
									...
									<ul class="list-group collapse in" id="feedList">
										<li class="list-group-item clearfix">
											...
											<div class="pull-left m-left-sm">
												<span>Ravi Jaiswal Add a new photo.</span><br/>
										...
										<li class="list-group-item clearfix">
											...
											<div class="pull-left m-left-sm">
												<span>Ravi Jaiswal commented on <a href="#">This Article</a></span><br/>
					...
					<div class="col-lg-4">
						<div class="panel bg-info fadeInDown">
							<div class="panel-body">
						...
						<div class="panel bg-success fadeInDown">
							<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-6">
					<span class="footer-brand">
						<strong class="text-danger">Sarah</strong> Admin
					</span>
					<p class="no-margin">
						&copy; 2017 <strong>Sarah Admin</strong>. ALL Rights Reserved. 
					</p>
				</div><!-- /.col -->
			</div><!-- /.row-->
		</footer>
	...
	<!-- Cookie -->
	<script src='js/jquery.cook.min.js'></script>
